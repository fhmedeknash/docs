...
description: "Choose Market POS, Restaurant POS, HAAT Integration API, or DaaS."
---
...
flowchart TD
  ...
  market --> haat[Also use HAAT Integration API]
  rest --> haat
  start --> q2{Only pushing status hours availability?}
  q2 -->|Yes| haatOnly[HAAT Integration API only]
...
<Tabs>
  ...
  <Tab title="HAAT Integration API">
    ...
    <Card title="HAAT Integration API" icon="plug" href="/haat-api/overview" horizontal cta="Open docs" arrow="true">
...
<Info>
  ...
  2. The HAAT Integration API for pushing operational updates back to HAAT
